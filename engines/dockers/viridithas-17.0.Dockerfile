...
RUN git init Viridithas && \
    ...
    git fetch --depth 1 origin d01202c2f6462bea31a5c77f1f99349bb94e3b35 && \
    git checkout FETCH_HEAD && \
    wget https://github.com/cosmobobak/viridithas-networks/releases/download/v98/falke-b200.nnue.zst -O viridithas.nnue.zst && \
