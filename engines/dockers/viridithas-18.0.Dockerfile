...
RUN git init Viridithas && \
    ...
    git fetch --depth 1 origin 0ef5ac11337dbee946c460a68730941aa5645823 && \
    git checkout FETCH_HEAD && \
    wget https://github.com/cosmobobak/viridithas-networks/releases/download/v99/delenda-b800.nnue.zst -O viridithas.nnue.zst && \
